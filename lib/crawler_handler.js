...
function _updateCrawlerInfo(_event, _bot) {
	...
	setInterval(async () => {
		...
		//let outString = ptt_refresh ?
		//	'<Refresh>' + '【PTT】' + ptt.titles[0] + ' - '+ ptt.titles.length + ' - ' + basic_f.getCurrentDateTime()
		//	: '【PTT】' + '-------------------------------------------' + basic_f.getCurrentDateTime();
		//funda.DebugMsg.fatal(outString);
		if (ptt_refresh) {
	...
	setTimeout(() => {
		setInterval(async () => {
			...
			//let outString = baha_refresh ?
			//	'<Refresh>' + '【BAHA】' + baha.titles[0] + ' - '+ baha.titles.length + ' - ' + basic_f.getCurrentDateTime()
			//	: '【BAHA】' + '-------------------------------------------' + basic_f.getCurrentDateTime();
			//funda.DebugMsg.fatal(outString);
			if (baha_refresh) {
	...
	setTimeout(() => {
		setInterval(async () => {
			...
			//let outString = tos_refresh ?
			//	'<Refresh>' + '【TOS】' + tos.titles[0] + ' - '+ tos.titles.length + ' - ' + basic_f.getCurrentDateTime()
			//	: '【TOS】' + '-------------------------------------------' + basic_f.getCurrentDateTime();
			//funda.DebugMsg.fatal(outString);
			if (tos_refresh) {
	...
	setTimeout(() => {
		setInterval(async () => {
			...
			//let outString = g8g_refresh ?
			//	'<Refresh>' + '【G8G】' + g8g.titles[0] + ' - '+ g8g.titles.length + ' - ' + basic_f.getCurrentDateTime()
			//	: '【G8G】' + '-------------------------------------------' + basic_f.getCurrentDateTime();
			//funda.DebugMsg.fatal(outString);
			if (g8g_refresh) {
