...
<<<<<<< HEAD
					if(air_db[idx_taipei].AQI) air_db[idx_taipei].AQI = '??';
					if(air_db[idx_hsinchu].AQI) air_db[idx_hsinchu].AQI = '??';
					if(air_db[idx_taichung].AQI) air_db[idx_taichung].AQI = '??';
					if(air_db[idx_nantou].AQI) air_db[idx_nantou].AQI = '??';
					if(air_db[idx_kaohsiung].AQI) air_db[idx_kaohsiung].AQI = '??';
=======
...
>>>>>>> c3e8b2e1fec3b8c234b02a72459af357fe46c993
