...
function _msg(_alt_txt, _date, _area_items) {
	...
	//basicFrame.body.contents.push(_anAreaItem);
	//basicFrame.body.contents.push(_aSeparator);
	//basicFrame.body.contents.push(_anAreaItem);
...
// Weather Flex Message Full Structure
/*
const _weather4 = {
	"type": "bubble",
	"size": "mega",
		...
		"contents": [{
			...
			},
			{
				...
				"contents": [{
						...
						"contents": [{
								"type": "icon",
								"url": "https://wayne65.ap.ngrok.io/lb_images/flex/weather/rainy.png",
								"size": "xxl"
							},
							{
								"type": "text",
