...
const COM_CHANCE_1 = 180; //150;
const COM_CHANCE_2 = 180; //150; 
const COM_CHANCE_3 = 180; //150; 
const COM_CHANCE_4 = 180; //150; 
const COM_CHANCE_5 = 180; //150;
const COM_CHANCE_6 = 0;   //150;
...
function _toro_10(_event, _bot, _doubleChance = CHANCE_NOT_DOUBLE){
	...
	for (i = 0; i < 10; i++) {
		...
		toroResult_picPath.push(
			c.TOSMM_TORO_PIC_PATH_LOCAL_RW + 'tos_img/' +
