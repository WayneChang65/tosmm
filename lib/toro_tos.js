...
const RARE_CHANCE_2 = 40; // 大獎 2
const RARE_CHANCE_3 = 40; // 大獎 3
const COM_CHANCE_1 = 40; //150;
const COM_CHANCE_2 = 174; //150; 
const COM_CHANCE_3 = 174; //150; 
const COM_CHANCE_4 = 174; //150; 
const COM_CHANCE_5 = 174; //150;
const COM_CHANCE_6 = 174; //150;
const COM_CHANCE_7 = 0;   //

// 加倍機率小數點一位
const RARE_CHANCE_1d = 26;	// 大獎 1 (保底)
const RARE_CHANCE_2d = 66;	// 大獎 2
const RARE_CHANCE_3d = 66;	// 大獎 3
const COM_CHANCE_1d = 66;  	//129;
const COM_CHANCE_2d = 155;	//129;
const COM_CHANCE_3d = 155;	//129;
const COM_CHANCE_4d = 155;	//129; 
const COM_CHANCE_5d = 155;	//129;
const COM_CHANCE_6d = 156;  //130;
